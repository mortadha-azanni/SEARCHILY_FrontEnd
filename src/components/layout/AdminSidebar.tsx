...
export default function AdminSidebar() {
  return (
    <aside className="flex flex-col w-full md:w-64 bg-mistral-black text-white shrink-0 h-[100dvh] sticky top-0 overflow-y-auto">
      <div className="p-6 border-b border-white/10 shrink-0">
        <h2 className="text-[20px] font-normal tracking-tight uppercase">Admin Panel</h2>
